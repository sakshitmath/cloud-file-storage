          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            {!searchResults && folders.map((folder) => (
              <div
                ...
                className={`bg-amber-50/80 border border-amber-100 p-4 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-200 ${view !== 'trash' ? 'cursor-pointer hover:-translate-y-0.5' : ''}`}
              >
            ...
            {(searchResults ?? files).map((file) => (
              <div
                ...
                className={`bg-white/90 backdrop-blur-sm p-4 rounded-2xl shadow-sm hover:shadow-lg transition-all duration-200 ${view !== 'trash' ? 'cursor-pointer hover:-translate-y-0.5' : ''}`}
              >
                <div className="flex justify-between items-start gap-2">
